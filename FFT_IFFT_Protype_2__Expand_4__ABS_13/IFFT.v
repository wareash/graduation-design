...
module IFFT (
	...
	asj_fft_sglstream_fft_111	asj_fft_sglstream_fft_111_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_sglstream_fft_111_inst.nps = 1024,
		asj_fft_sglstream_fft_111_inst.bfp = 1,
		asj_fft_sglstream_fft_111_inst.nume = 1,
		asj_fft_sglstream_fft_111_inst.mpr = 8,
		asj_fft_sglstream_fft_111_inst.twr = 8,
		asj_fft_sglstream_fft_111_inst.bpr = 16,
		asj_fft_sglstream_fft_111_inst.bpb = 4,
		asj_fft_sglstream_fft_111_inst.fpr = 4,
		asj_fft_sglstream_fft_111_inst.mram = 0,
		asj_fft_sglstream_fft_111_inst.m512 = 0,
		asj_fft_sglstream_fft_111_inst.mult_type = 1,
		asj_fft_sglstream_fft_111_inst.mult_imp = 0,
		asj_fft_sglstream_fft_111_inst.dsp_arch = 0,
		asj_fft_sglstream_fft_111_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_sglstream_fft_111_inst.rfs1 = "IFFT_1n1024sin.hex",
		asj_fft_sglstream_fft_111_inst.rfs2 = "IFFT_2n1024sin.hex",
		asj_fft_sglstream_fft_111_inst.rfs3 = "IFFT_3n1024sin.hex",
		asj_fft_sglstream_fft_111_inst.rfc1 = "IFFT_1n1024cos.hex",
		asj_fft_sglstream_fft_111_inst.rfc2 = "IFFT_2n1024cos.hex",
		asj_fft_sglstream_fft_111_inst.rfc3 = "IFFT_3n1024cos.hex";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_sglstream_fft_111" >
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="3041"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="IFFT.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="IFFT_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
