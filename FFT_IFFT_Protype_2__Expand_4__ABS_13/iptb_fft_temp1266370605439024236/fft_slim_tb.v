...
initial
   begin
     ...
     fftpts_array[2]=128;
     fftpts_array[3]=128;
     data_rf = $fopen("fft_slim_real_input.txt","r");
     data_if = $fopen("fft_slim_imag_input.txt","r");
     fft_rf = $fopen("fft_slim_real_output_ver.txt");
     fft_if =$fopen("fft_slim_imag_output_ver.txt");
     expf = $fopen("fft_slim_exponent_output_ver.txt");
     #0 clk = 1'b0;
     #0 reset_n = 1'b0;
     #92 reset_n = 1'b1;
  end
