...
initial
   begin
     ...
     fftpts_array[2]=1024;
     fftpts_array[3]=1024;
     data_rf = $fopen("IFFT_real_input.txt","r");
     data_if = $fopen("IFFT_imag_input.txt","r");
     fft_rf = $fopen("IFFT_real_output_ver.txt");
     fft_if =$fopen("IFFT_imag_output_ver.txt");
     expf = $fopen("IFFT_exponent_output_ver.txt");
     #0 clk = 1'b0;
     #0 reset_n = 1'b0;
     #92 reset_n = 1'b1;
  end
